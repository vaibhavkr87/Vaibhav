    ...
    <div className="container mx-auto px-8 md:px-16 lg:px-24">
      <div className="flex flex-col md:flex-row md:space-x-12 items-center mb-4">
        <div className="flex-1 mb-4 md:mb-0">
          <h3 className="text-2xl font-bold mb-2">Vaibhav Kumar</h3>
      ...
      >
        <p className="text-gray-400">
          &copy; {new Date().getFullYear()} Vaibhav Kumar. All rights reserved.
        </p>
        <div className="flex space-x-4 my-4 md:my-0">
          ...
          <a href="https://x.com/" target='_blank' className="text-gray-400 hover:text-white">
            Twitter
          </a>
          <a href="https://www.linkedin.com/" target='_blank' className="text-gray-400 hover:text-white">
            Linkedin
          </a>
          <a href="https://github.com/vaibhavkr87" target='_blank' className="text-gray-400 hover:text-white">
            Github 
          </a>
        </div>
